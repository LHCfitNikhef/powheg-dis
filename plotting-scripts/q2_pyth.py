...
#               
#
#            PWG+PY8 LO, NLO, Pythia Stand-alone
#
#
#
########################################################
...
file_names_lo = [
                '../DATA/Q2/LO/fixed_scales.dat',
                '../DATA/Q2/LO/fixed_scales-1.dat',                
                  ]

files_lo_min = [
                '../DATA/Q2/LO/fixed_scales_min.dat',
                '../DATA/Q2/LO/fixed_scales_min-1.dat',
               ]

files_lo_max = [
                '../DATA/Q2/LO/fixed_scales_max.dat',
                '../DATA/Q2/LO/fixed_scales_max-1.dat',
               ]


file_names_nlo = [
                  '../DATA/Q2/NLO/fixed_scales.dat',
                  '../DATA/Q2/NLO/fixed_scales-1.dat',
                  ]
 
file_names_min = [
                  '../DATA/Q2/NLO/fixed_scales_min.dat',
                  '../DATA/Q2/NLO/fixed_scales_min-1.dat',
                  ]

file_names_max = [
                  '../DATA/Q2/NLO/fixed_scales_max.dat',
                  '../DATA/Q2/NLO/fixed_scales_max-1.dat',
                  ] 

pythia_file = '../DATA/Q2/Pythia/q2.dat'
    ...
    for file_name in file_names:
        ...
        with open(file_name, 'r') as file:
            for line in file:
                ...
                columns = line.split()
                if len(columns) >= 4:
                    x_values.append((float(columns[1]) + float(columns[0])) / 2)
...
p1, = axs[0].plot(q2_pyth, pyth_sigma, drawstyle='steps-post',
...
axs[0].set_ylim(10**-5,10**-0.7)
axs[0].set_xticklabels([])
axs[0].set_ylabel(r'$d\sigma / dQ^2\ \mathrm{[pb/GeV^2]}$')
...
axs[1].set_xlabel(r"$Q^2\, \mathrm{[GeV^2]} $")
axs[1].set_ylabel(r'$\rm Ratio \ to \ PW \ LO$', fontsize=8, labelpad=6)
...
plt.savefig('q2_41.pdf', format='pdf')
