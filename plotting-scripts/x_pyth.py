...
file_names_lo = [
                '../DATA/x/LO/fixed_scales.dat',
                '../DATA/x/LO/fixed_scales-1.dat',                
                  ]

files_lo_min = [
                '../DATA/x/LO/fixed_scales_min.dat',
                '../DATA/x/LO/fixed_scales_min-1.dat',
               ]

files_lo_max = [
                '../DATA/x/LO/fixed_scales_max.dat',
                '../DATA/x/LO/fixed_scales_max-1.dat',
               ]


file_names_nlo = [
                  '../DATA/x/NLO/fixed_scales.dat',
                  '../DATA/x/NLO/fixed_scales-1.dat',
                  ]
 
file_names_min = [
                  '../DATA/x/NLO/fixed_scales_min.dat',
                  '../DATA/x/NLO/fixed_scales_min-1.dat',
                  ]

file_names_max = [
                  '../DATA/x/NLO/fixed_scales_max.dat',
                  '../DATA/x/NLO/fixed_scales_max-1.dat',
                  ] 

pythia_file = '../DATA/x/Pythia/x.dat'
...
p1, = axs[0].plot(x_pyth, pyth_sigma, drawstyle='steps-post',
...
#           RATIO TO LO PANEL (BOTTOM PANEL)
...
axs[0].set_ylabel(r'$d\sigma / dx \ \mathrm{[pb]}$')
...
axs[1].set_ylabel(r'$\rm Ratio \ to \ PW \ LO$', fontsize=8, labelpad=15)
...
plt.savefig('x_41.pdf', format='pdf')
