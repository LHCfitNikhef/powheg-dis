...
file_names_lo = [
                '../DATA/Energy-lep/FASER/LO/dyn_scales.dat',
                '../DATA/Energy-lep/FASER/LO/dyn_scales-1.dat',
                 ]

files_lo_min = [
                '../DATA/Energy-lep/FASER/LO/dyn_scales_min.dat',
                '../DATA/Energy-lep/FASER/LO/dyn_scales_min-1.dat',
               ]

files_lo_max = [
                '../DATA/Energy-lep/FASER/LO/dyn_scales_max.dat',
                '../DATA/Energy-lep/FASER/LO/dyn_scales_max-1.dat',
               ]

file_names_nlo = [
                '../DATA/Energy-lep/FASER/NLO/dyn_scales.dat',
                '../DATA/Energy-lep/FASER/NLO/dyn_scales-1.dat',   
                  ]
 
file_names_min = [
                '../DATA/Energy-lep/FASER/NLO/dyn_scales_min.dat', 
                '../DATA/Energy-lep/FASER/NLO/dyn_scales_min-1.dat',
                  ]

file_names_max = [
                '../DATA/Energy-lep/FASER/NLO/dyn_scales_max.dat',
                '../DATA/Energy-lep/FASER/NLO/dyn_scales_max-1.dat',

genie_data = "../DATA/Energy-lep/GENIE/genie_nu_e.dat"
...
axs[1].set_xticks(np.arange(100, 910, 100))
...
plt.savefig('Elep_44.pdf', format='pdf')
