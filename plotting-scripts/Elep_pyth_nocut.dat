...
file_names_lo = [
                '../DATA/Energy-lep/LO/fixed_scales.dat',
                '../DATA/Energy-lep/LO/fixed_scales-1.dat',
                 ]

files_lo_min = [
                '../DATA/Energy-lep/LO/fixed_scales_min.dat',
                '../DATA/Energy-lep/LO/fixed_scales_min-1.dat',
               ]

files_lo_max = [
                '../DATA/Energy-lep/LO/fixed_scales_max.dat',
                '../DATA/Energy-lep/LO/fixed_scales_max-1.dat',
               ]

file_names_nlo = [
                '../DATA/Energy-lep/NLO/fixed_scales.dat',
                '../DATA/Energy-lep/NLO/fixed_scales-1.dat',
                  ]
 
file_names_min = [
                '../DATA/Energy-lep/NLO/fixed_scales_min.dat',
                '../DATA/Energy-lep/NLO/fixed_scales_min-1.dat',
                  ]

file_names_max = [
                '../DATA/Energy-lep/NLO/fixed_scales_max.dat',
                '../DATA/Energy-lep/NLO/fixed_scales_max-1.dat',
                
                  ] 


pythia_file = '../DATA/Energy-lep/Pythia/nocut.dat'
...
plt.savefig('Elep_42_nocut.pdf', format='pdf')
