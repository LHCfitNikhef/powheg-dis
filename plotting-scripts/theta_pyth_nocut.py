...
file_names_lo = [
                '../DATA/theta/LO/fixed_scales.dat',
                '../DATA/theta/LO/fixed_scales-1.dat',
                 ]

files_lo_min = [
                '../DATA/theta/LO/fixed_scales_min.dat',
                '../DATA/theta/LO/fixed_scales_min-1.dat',
               ]

files_lo_max = [
                '../DATA/theta/LO/fixed_scales_max.dat',
                '../DATA/theta/LO/fixed_scales_max-1.dat',
               ]

file_names_nlo = [
                '../DATA/theta/NLO/fixed_scales.dat', 
                '../DATA/theta/NLO/fixed_scales-1.dat',
                
                  ]
 
file_names_min = [
                '../DATA/theta/NLO/fixed_scales_min.dat',
                '../DATA/theta/NLO/fixed_scales_min-1.dat',                         
                  ]

file_names_max = [
                '../DATA/theta/NLO/fixed_scales_max.dat', 
                '../DATA/theta/NLO/fixed_scales_max-1.dat',                     
                  ] 


pythia_file = '../DATA/theta/Pythia/nocut.dat'
...
plt.savefig('theta_42_nocut.pdf', format='pdf')
