c -*-Fortran-*-
     ...
     #   kn_softvec(0:3),
     #   kn_csimax,kn_csimin,kn_csimax_minus,kn_csimax_delta,kn_csimaxp,kn_csimaxm,
     ...
     #   kn_q0,kn_branchfactor,kn_bfpreal(0:3,nlegreal),kn_bfpborn(0:3,nlegborn)


      integer kn_emitter,kn_resemitter

      common/pwhg_kn/kn_pborn,kn_cmpborn,kn_preal,kn_cmpreal,kn_y,
     #   kn_sborn,kn_sreal,kn_azi,kn_csitilde,kn_softvec,kn_csimax,kn_csimin,kn_csimax_minus,kn_csimax_delta,
     ...
     #   kn_minmass,kn_born_pt2, kn_cthdec,kn_q0,kn_branchfactor,
     #   kn_bfpreal,kn_bfpborn,
c integers
     #   kn_emitter,kn_resemitter
