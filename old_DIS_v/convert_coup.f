...
c
c photon:
      V(1,1) = zero ! neutrino type 
      V(2,1) = -E ! charged lepton(electron) type
      V(3,1) = 2.d0*E/3.d0 !up type
      V(4,1) = -E/3.d0 !down type
c Z boson:
      V(1,2) =  Z
