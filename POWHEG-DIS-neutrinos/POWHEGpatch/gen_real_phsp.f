...
! jac          : jacobian factor on phirad
      subroutine barradmap_dis(n,q0,csi,y,phi3,phi5,xbar,x,beams,xk,Jac)
      implicit none
      include 'nlegborn.h'
      ! include 'pwhg_kn.h'
      include 'pwhg_math.h'
      ...
      double precision :: yDIS, phi3, csi, phi5, c5, s, x, lambda, 
     ...
     -            Jac, invmsq, cpsi, phi5r, beams(0:3,2), dotp
      ...
      c5 = y
      yDIS = q0**2/(xbar*2d0 * dotp(beams(:,1),beams(:,2)))
      phi5r = phi5 + phi3
...
!     First compute Q2 assuming that the electron is particle 1 and 3
     ...
     $           ,y,phi3,azi,xb2,x2,beams,xk,jacreal)
         else
