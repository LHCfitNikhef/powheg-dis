...
c...reads event information from a les houches events file on unit nlf. 
      ...
      integer i,j,iret
      integer flav1,flav2
      real * 8 x1,x2,mufactscale,xf1,xf2
...
!            string(1:4)=" "
!            READ(string,*,ERR=1) flav1,flav2,x1,x2,mufactscale,xf1,xf2
!            WRITE(*,*)"Reading from LHE file",flav1,flav2,x1,x2,mufactscale,xf1,xf2
!            pdfinfo_f1=flav1
!            pdfinfo_f2=flav2
!            pdfinfo_x1=x!1
!            pdfinfo_x2=x2
!            pdfinfo_scale=mufactscale
!            pdfinfo_xf1=xf1
!            pdfinfo_xf2=xf2
!         END IF
         if(iret.ne.0) goto 1
