...
c---------------------------------------------------------------------------
c
      subroutine qq_ee_custom(pbar,sign, nlo, L,k,ans)
      implicit none
c
c	Last modified for POWHEG by Barbara Jaeger: 2019 Oct
c
...
C  for 
c
c  INPUT:  NLO = 1       return uuee = 2Re(M_Born^* M_virt)
c          NLO = 0       return uuee = |M_born|^2   etc.
c
      real * 8 pi,pi2
...
c
         ...
         ifl(2,kl) = 1
         ifl(3,kl) = 3
         ifl(4,kl) = 4 !fermion=neutrino type
