...
!  pwhgfill  :  fills the histograms with data
      ...
      subroutine init_hist
         ...
         include 'pwhg_kn.h'
         CALL init_dists
         CALL bookupeqdd("myxQ2",0.0d0,1.0d0,0.1d0,25d0,1000.0d0,50d0,nweights=8)
         CALL bookupeqdd("myxQ2y",0.0d0,1.0d0,0.1d0,25d0,1000.0d0,50d0,0.0d0,1.0d0,0.1d0,nweights=8)
         call inihists
...
!         call bookupeqbins('Q2', (1000d0-25d0)/20d0, 25d0, 1000d0)
         call bookupeqbins('Q2', (1025d0-25d0)/20d0, 25d0, 1000d0)
      ...
      subroutine analysis(dsig0)
         ...
         ! includes for the lumi
         include 'pwhg_pdfinfo.h'
         include 'pwhg_pdf.h'
         include 'pwhg_rad.h'
         include 'pwhg_flst.h'
         ! end includes lumi
...
C         if (nunident>0) print*, 'nunident', nunident
...
! Get the luminosity for the born process:
         lumbornorig = pdfinfo_xf1*pdfinfo_xf2/pdfinfo_x1/pdfinfo_x2

         CALL filldd('myxQ2',dsig/lumbornorig,x,Q2)
         CALL filldd('myxQ2y',dsig/lumbornorig,x,Q2,y)
